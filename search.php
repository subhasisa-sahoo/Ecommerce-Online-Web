...
<body>
    ...
    ?>
    <div class="product_container" data-asor="fade-up">
        <h3 class="pro_heading"><?php echo "You are Searching for: ", $searchQuery; ?></h3>
        <div class="category">
            <?php
            $product_query = "SELECT * FROM `craftshop_sellerdb`.`product` WHERE product_name LIKE '%$searchQuery%' OR description LIKE '%$searchQuery%' OR category LIKE '%$searchQuery%'";
            ...
            <?php
                ...
                "<h3 class='pro_heading'>No data Found</h3>";
            }
            ?>
        </div>
    </div>
